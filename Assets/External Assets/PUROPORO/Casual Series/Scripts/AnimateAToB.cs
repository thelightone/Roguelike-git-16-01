...
{
    /// <summary>
    /// This class is a very simple Tween-animation style animator for animating a subject from point a to point b.
    /// However, I recommend getting a better Tween implementation such as DOTween, HOTween, LeanTween, iTween, etc.
    /// </summary>
    public class AnimateAToB : MonoBehaviour
    {
        public Transform m_Subject;
